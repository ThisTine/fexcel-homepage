...
const HowItWorks:FC = ()=>{
    return(
        ...
        <div className='bg-[#E2E6F9] w-full overflow-hidden' > <h1 className='text-center font-bold text-5xl py-3 font-Dongle  ' data-aos="flip-up" >How does Fexcel work ? </h1> </div>
        <div className=' container flex flex-col-reverse gap-5 lg:flex-row-reverse my-10 items-center'>
          <div className=' flex-[6] flex flex-col gap-5 items-center'>
            ...
            <p className="mt-5">Fexcel ช่วยให้การใช้งาน Excel ง่ายยิ่งขึ้นโดยใช้ความสามารถของ AI ซึ่งจะสามารถช่วยให้ผู้ใช้งานไม่ต้องกังวลกับการจำสูตรต่าง ๆ อีกต่อไป</p>
            </div>
            <div className="flex w-full items-center gap-3" >
                <div className="flex-grow w-full h-[1px] bg-black" ></div>
                <p className="flex-1 whitespace-nowrap">นอกจากนี้ Flexcel ยังสามารถ</p>
                <div className="flex-grow w-full h-[1px] bg-black" ></div>
            </div>
