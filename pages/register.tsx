...
const Register:NextPage = ()=>{
    ...
    <main className="min-h-screen bg-[#E2E6F9] p-20 border-4 border-solid border-[#FFC700]">
        <div className="w-full h-20"></div>
        <div className="container mx-auto mt-10 flex flex-col" >
        <h1 className="text-8xl text-center font-Dongle " data-aos="fade-up" >Email Sign-up</h1>
        <h4 className='text-3xl text-center font-semibold' data-aos="fade-up" >ลงทะเบียนอีเมลเพื่อใช้บริการและรับข่าวสารสำคัญจากเรา</h4>
