  ...
  return (
    <main className="min-h-screen mt-28 flex items-center w-full flex-col">
      ...
      >
          ...
          <a rel="noreferrer" className="p-5 text-lg px-8 w-fit rounded-lg hover:bg-purple-800 transition-all focus:ring-4 bg-purple-600 text-white" href="https://forms.gle/ggnnmc5mcCGkaYk57" target={"_blank"} >FeedBack !</a>
          </div>
      </Modal>
      <div className="container sm:w-full">
        ...
        <div className="mt-5" data-aos="fade-up" data-aos-delay="200">
            <a rel="noreferrer" href="https://forms.gle/ggnnmc5mcCGkaYk57" target={"_blank"} className=" p-3 text-lg px-8 w-fit rounded-lg hover:bg-purple-800 transition-all focus:ring-4 bg-purple-600 text-white" >FeedBack !</a>
        </div>
      </div>
    </main>
  );
